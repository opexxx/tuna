...
module UjsSortHelper
  ...
  #
  def sort_link(column, caption=nil, initial_order="asc", options)
  ...
  def sort_header_tag(column, options = {})    
    ...
    content_tag('th', sort_link(column, caption, initial_order, options), options.except(:initial_order))
	
#	puts "DEBUG!" + options.to_s
